...
public class FluttersharePlugin : FlutterPlugin, MethodCallHandler, ActivityAware {
  ...
  override fun onAttachedToEngine(@NonNull flutterPluginBinding: FlutterPlugin.FlutterPluginBinding) {
    methodChannel = MethodChannel(flutterPluginBinding.flutterEngine.dartExecutor, "fluttershare")
  ...
  companion object {
    ...
    fun registerWith(registrar: Registrar) {
      val channel = MethodChannel(registrar.messenger(), "fluttershare")
      channel.setMethodCallHandler(FluttersharePlugin(registrar.activity()))
      shareFacebookInit(registrar.activity())
